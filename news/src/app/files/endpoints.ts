export const API_KEY: string = "deb7c50ba99f4e0288001d409256d7ff";

export const TOP_HEADLINES = "https://newsapi.org/v2/top-headlines";

export const TOP_NEWS_ENDPOINT_US: string = TOP_HEADLINES+"?country=us&apiKey="+API_KEY;
export const TOP_NEWS_ENDPOINT_GB: string = TOP_HEADLINES+"?country=gb&apiKey="+API_KEY;
